...
import 'package:data_dex/application/applicant_form/applicant_form_bloc.dart'
    as _i9;
import 'package:data_dex/application/auth/auth_bloc.dart' as _i10;
import 'package:data_dex/application/auth/signin/signin_bloc.dart' as _i8;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i8.SigninBloc>(() => _i8.SigninBloc(gh<_i6.IAuthFacade>()));
    gh.factory<_i9.ApplicantFormBloc>(
        () => _i9.ApplicantFormBloc(gh<_i4.IApplicantRepository>()));
