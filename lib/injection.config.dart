...
import 'package:data_dex/application/app_action/app_action_cubit.dart' as _i20;
import 'package:data_dex/application/applicant_form/applicant_form_bloc.dart'
    as _i21;
import 'package:data_dex/application/auth/auth_bloc.dart' as _i22;
import 'package:data_dex/application/auth/signin/signin_bloc.dart' as _i19;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i17.LoanParticularsFormBloc>(() =>
        _i17.LoanParticularsFormBloc(gh<_i13.ILoanParticularsRepository>()));
    gh.factory<_i18.LoanWatcherBloc>(
        () => _i18.LoanWatcherBloc(gh<_i15.ILoanRepository>()));
    gh.factory<_i19.SigninBloc>(() => _i19.SigninBloc(gh<_i5.IAuthFacade>()));
    gh.factory<_i20.AppActionCubit>(
        () => _i20.AppActionCubit(gh<_i9.ICommonRepository>()));
    gh.factory<_i21.ApplicantFormBloc>(() => _i21.ApplicantFormBloc(
          gh<_i3.IApplicantRepository>(),
          gh<_i15.ILoanRepository>(),
        ));
    gh.factory<_i22.AuthBloc>(() => _i22.AuthBloc(gh<_i5.IAuthFacade>()));
    gh.factory<_i23.CoApplicantFormBloc>(
        () => _i23.CoApplicantFormBloc(gh<_i7.ICoApplicantRepository>()));
    gh.factory<_i24.GuarenterFormBloc>(
        () => _i24.GuarenterFormBloc(gh<_i11.IGuarenterRepository>()));
    return this;
  }
}
