...
class ApplicantImagePickerContainer extends StatelessWidget {
    ...
    return BlocBuilder<MiscellaneousDetailsFormBloc,
      ...
      builder: (context, state) {
        return Container(
          ...
          child: state.applicantImage == null
              ? state.isApplicantImageUploading
                  ? const SizedBox(
                      width: double.infinity,
                      height: 100,
                      child: Column(
              ...
              : SizedBox(
                  height: 100,
                  width: double.infinity,
                  child: Image.network(state.applicantImage!.url),
                ),
        );
      },
    );
