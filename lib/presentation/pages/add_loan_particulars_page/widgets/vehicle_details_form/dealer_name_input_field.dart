...
class DealerNameInputField extends HookWidget {
  const DealerNameInputField({super.key});
        ...
        return TextFormField(
          ...
          validator: (_) => context
              ...
              .fold(
                (f) => state.formStep == 0
                    ? f.maybeMap(
                        empty: (_) => "Dealer name can't be empty",
                        orElse: () => null,
                      )
                    : null,
                (_) => null,
              ),
          onChanged: (dealerName) => context
              .read<LoanParticularsFormBloc>()
              .add(LoanParticularsFormEvent.dealerNameChanged(dealerName)),
        );
      },
    );
  }
